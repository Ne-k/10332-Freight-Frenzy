...
@TeleOp
public class OpModeBackUp extends LinearOpMode
{
    public void runOpMode() throws InterruptedException {
        ...
        while (this.opModeIsActive()) {
            final double y = (-this.gamepad1.left_stick_y)* .8;
            final double x = -this.gamepad1.left_stick_x * .8;
            final double rx = this.gamepad1.right_stick_x*.8;
            ...
            //.35
            final double spinnerPow = 1;
            final double spinnerPowRev = 1;
            ...
            if((gamepad1.x || gamepad1.b == true || gamepad2.x || gamepad2.b ==true)){
                extServo.setPosition(servoMiddlePos);
                extServo2.setPosition(servoMiddlePos);
            }
            else if ((!this.gamepad1.x && !this.gamepad2.x) || (!this.gamepad1.x && !this.gamepad2.x)) {
            ...
            else if (this.gamepad1.right_bumper || gamepad2.left_bumper) {
